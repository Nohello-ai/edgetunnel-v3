 ...
 * TLS 加密函数模块
 *
 * 包含字节工具、HMAC/HKDF/PRF 派生、ECDHE 密钥协商、AES-GCM 与
 * ChaCha20-Poly1305 加解密，以及流量密钥派生等密码学原语。
 * 提取自原始 Cloudflare Workers 单文件 worker.js（第 2952-3113 行，含 3268-3275 行的 uint64be/xorSequenceIntoIv/deriveTrafficKeys）。
 */

import { textEncoder, EMPTY_BYTES } from "./constants.js";
